...
def test_algoBB_4():
    c4 = CubeN(4)
    algo = Algorithm("L2 B2 D2 L2 B2 D2 R L D2 L F2 D' L U B R L2 B2 D' F2 Fw2 L U' F2 Rw2 D R2 U' Fw2 Uw2 Fw2 D2 Fw' L F' R Fw2 D2 Uw' Rw2 F' Uw2 Fw R' Uw")
    c4 >> algo
    c4 >> -algo
    assert c4.isSolved()
